...
define([
     ...
     */
    $.widget('mage.categoryBannerGallery', {
        options: {
    ...
    // Extension for mage.categoryBannerGallery - Add advanced settings block
    $.widget('mage.categoryBannerGallery', $.mage.categoryBannerGallery, {
        options: {
    ...
    return $.mage.categoryBannerGallery;
});
/**
 * Copyright © Magento, Inc. All rights reserved.
 * See COPYING.txt for license details.
